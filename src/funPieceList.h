...
#define MACHINE_MIN_P (double) -1e7//-INFINITY
#define MACHINE_MAX_P (double) 1e7//INFINITY
...
public:
  ...
  void print();
  void set_to_scaled_fwd(PiecewiseSquareLoss *, double);
  void set_to_scaled_rev(PiecewiseSquareLoss *, double);
...
public:
    ...
    void rescale(int fwd, double decay_rate);
    void print();
    PiecewiseSquareLoss min_over_u();
};
